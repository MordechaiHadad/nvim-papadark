...
local theme = lush(function()
    return {
        ...
        Normal       {fg = foreground }, -- normal text
        ...
        SpellBad     {bg = red, gui = "underline" }, -- Word that is not recognized by the spellchecker. |spell| Combined with the highlighting used otherwise. 
